...
export default function HealthIndexRoute() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Health & Medical Services</Text>
        <Text style={styles.sub}>Coming Soon — Health Department Team</Text>
      </View>
    </ScrollView>
  );
}
