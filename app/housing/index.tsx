...
export default function HousingIndexRoute() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Housing & Urban Development</Text>
        <Text style={styles.sub}>Coming Soon — Housing Department Team</Text>
      </View>
    </ScrollView>
  );
}
